...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameResultSkin() {
		_super.call(this);
		this.skinParts = ["alphaRect1","alphaRect","alphaRect0","img_result1","gp_people1","lab_otherName","group_flower","group_result1","img_result2","gp_people2","lab_masterName","group_result2","gp_particle","gp_wenzi","group_selected","btn_leave","btn_again","group_btns"];
	...
	_proto.group_result1_i = function () {
		...
		t.x = 10;
		t.elementsContent = [this.img_result1_i(),this.gp_people1_i(),this.lab_otherName_i(),this.group_flower_i()];
		return t;
	};
	...
	_proto.group_result2_i = function () {
		...
		t.x = 807.72;
		t.y = 0.91;
		t.elementsContent = [this.img_result2_i(),this.gp_people2_i(),this.lab_masterName_i()];
		return t;
	};
	...
	_proto.lab_masterName_i = function () {
		var t = new eui.Label();
		this.lab_masterName = t;
		t.anchorOffsetX = 0;
		t.scaleX = 1;
		t.scaleY = 1;
		t.size = 40;
