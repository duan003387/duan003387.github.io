window.skins={};
                ...
                generateEUI.skins = {"eui.Button":"resource/eui_skins/ButtonSkin.exml","eui.CheckBox":"resource/eui_skins/CheckBoxSkin.exml","eui.HScrollBar":"resource/eui_skins/HScrollBarSkin.exml","eui.HSlider":"resource/eui_skins/HSliderSkin.exml","eui.Panel":"resource/eui_skins/PanelSkin.exml","eui.TextInput":"resource/eui_skins/TextInputSkin.exml","eui.ProgressBar":"resource/eui_skins/ProgressBarSkin.exml","eui.RadioButton":"resource/eui_skins/RadioButtonSkin.exml","eui.Scroller":"resource/eui_skins/ScrollerSkin.exml","eui.ToggleSwitch":"resource/eui_skins/ToggleSwitchSkin.exml","eui.VScrollBar":"resource/eui_skins/VScrollBarSkin.exml","eui.VSlider":"resource/eui_skins/VSliderSkin.exml","eui.ItemRenderer":"resource/eui_skins/ItemRendererSkin.exml","start":"resource/mySkins/start.exml","game":"resource/mySkins/game.exml","GameOver":"resource/mySkins/GameOver.exml","nima":"resource/mySkins/nima.exml","nkk":"resource/mySkins/nkk.exml"};generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	return VSliderSkin;
})(eui.Skin);generateEUI.paths['resource/mySkins/game.exml'] = window.gameSkin = (function (_super) {
	...
	return gameSkin;
})(eui.Skin);generateEUI.paths['resource/mySkins/GameOver.exml'] = window.GameOverSkin = (function (_super) {
	__extends(GameOverSkin, _super);
	function GameOverSkin() {
		_super.call(this);
		this.skinParts = ["btnPlayAgain","btnFenXiang","scoreText"];
		
		this.height = 960;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this.btnPlayAgain_i(),this.btnFenXiang_i(),this._Label1_i(),this.scoreText_i()];
	}
	...
	return GameOverSkin;
})(eui.Skin);generateEUI.paths['resource/mySkins/start.exml'] = window.startSkin = (function (_super) {
